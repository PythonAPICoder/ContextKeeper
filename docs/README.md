...
| --- | --- | --- |
| `README.md` | Current | Modern project landing page synchronized in B5.6. |
| `docs/README.md` | Current | Documentation index and audit inventory. |
| `docs/ARCHITECTURE.md` | Current | Runtime/dashboard architecture source-aligned in B5.6. |
| `docs/API_COMPATIBILITY.md` | Current | Ollama compatibility and request-observation boundaries. |
| `docs/CONFIGURATION.md` | Current | Source-verified defaults, overrides, thresholds, and precedence. |
| `docs/TEST_PLAN.md` | Current | Expanded automated/manual/visual/regression validation plan. |
| `docs/ROADMAP.md` | Current | Active roadmap synchronized through B5.5.2 and B5.6. |
| `docs/PROJECT_HISTORY.md` | Current | Phase record through B5.6. |
...
| `docs/UI_COMPONENT_GUIDE.md` | Current | Compact dashboard component guidance. |
